...
htmlhelp_basename = 'bucketcachedoc'
...
latex_documents = [
    ('index', 'BucketCache.tex', 'BucketCache Documentation',
     AUTHOR, 'manual'),
]
...
man_pages = [
    ('index', 'BucketCache', 'BucketCache Documentation',
     [AUTHOR], 1)
]
...
texinfo_documents = [
    ('index', 'BucketCache', 'BucketCache Documentation',
     AUTHOR, 'BucketCache', DESCRIPTION,
     'Miscellaneous'),
]
